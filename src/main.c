...
int chirc_run(chirc_ctx_t *ctx)
{
     ...
     * 
     * 1. Initialize server
     * 2. Pass it to a helper function that actuall deals with running the server.
     *    I think it makes most sense to make this in server.c
     * 
     * Unsure where the clients come in...
    */
